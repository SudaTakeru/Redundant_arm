function [Results,Results2,clusters,clustersb]=TRR7(dataseta,datasetb,test,number_of_redundant,k,k2,k3,ips,r)
...
% point or not % r<=ips => point
% 1st KNN --> r nn
% results‚ªŠÖ”‚É‚È‚Á‚½‚Æ‚«IDW‚â‚è‚Ü‚­‚é
% k3 means IDW paremeter when many IDW are conducted

import edu.stanford.math.plex4.*;

per=0.9; % “_orŠÖ”‚ÌipsˆÈ‰º‚ÌŠ„‡
...
max_dimension = 1;%+size(datasetb,2);
division_time=20;
