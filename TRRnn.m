function [Results,clusters,clustersb]=TRRnn(dataseta,datasetb,test,number_of_redundant,k,k2)
...
% TRRnn don't use IDW, but use KNN.
...
for j=1:Nt
    ...
    for ii=1:numcluster(j,1)
        ...
        output{ii}=clustersb{j}{ii}(indexes,:);
